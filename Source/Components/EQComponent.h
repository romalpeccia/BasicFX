...
#include "../Processors/EQProcessor.h"
    ...
    private:
        ...
        CustomSlider lowFrequencySlider{ "LowPass Frequency", "Hz", EQ_COLOUR_1,  EQ_COLOUR_2 };
        CustomSlider highFrequencySlider{ "HighPass Frequency", "Hz", EQ_COLOUR_1,  EQ_COLOUR_2 };

        std::unique_ptr<juce::AudioProcessorValueTreeState::ButtonAttachment> buttonAttachment;
        std::unique_ptr<juce::AudioProcessorValueTreeState::ComboBoxAttachment> menuAttachment;
        std::unique_ptr<juce::AudioProcessorValueTreeState::SliderAttachment> lowFrequencySliderAttachment;
        std::unique_ptr<juce::AudioProcessorValueTreeState::SliderAttachment> highFrequencySliderAttachment;
    };